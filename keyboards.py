...
def captcha_kb(auto: str | None = None):
    ...
    rows.append([InlineKeyboardButton(text="🔄 Yangi rasm",
...
def more_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="📁 Excel fayl (/export)", callback_data="more:export"),
         InlineKeyboardButton(text="📊 Ro'yxatim", callback_data="more:status")],
    ])
